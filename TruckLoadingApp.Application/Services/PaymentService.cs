...
namespace TruckLoadingApp.Application.Services
{
    public class PaymentService : IPaymentService
    {
        ...
        {
            _logger.LogInformation($"Processing payment for BookingId: {request.BookingId}, Amount: {request.Amount}");
            ...
            _logger.LogInformation($"Payment recorded for BookingId: {request.BookingId}, PaymentId: {payment.Id}");
