...
namespace TruckLoadingApp.Infrastructure.Migrations
{
    ...
    [Migration("20250228185721_updatedRelations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruckLoadingApp.Domain.Models.DriverRoutePreference", b =>
                {
                    ...
                    b.HasIndex("DriverId1")
                        .IsUnique()
                        .HasFilter("[DriverId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Truck", b =>
                {
                    b.HasOne("TruckLoadingApp.Domain.Models.Driver", "AssignedDriver")
                        .WithOne()
                        .HasForeignKey("Truck", "AssignedDriverId")
            ...
            modelBuilder.Entity("TruckLoadingApp.Domain.Models.DriverPerformance", b =>
                {
                    b.HasOne("TruckLoadingApp.Domain.Models.Driver", "Driver")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_DriverPerformance_Drivers_DriverId");

                    b.HasOne("TruckLoadingApp.Domain.Models.Driver", null)
            ...
            modelBuilder.Entity("TruckLoadingApp.Domain.Models.DriverRoutePreference", b =>
                {
                    b.HasOne("TruckLoadingApp.Domain.Models.Driver", "Driver")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_DriverRoutePreference_Drivers_DriverId");

                    b.HasOne("TruckLoadingApp.Domain.Models.Driver", null)
                        .WithOne("RoutePreferences")
                        .HasForeignKey("TruckLoadingApp.Domain.Models.DriverRoutePreference", "DriverId1");
            ...
            modelBuilder.Entity("TruckLoadingApp.Domain.Models.DriverSchedule", b =>
                {
                    b.HasOne("TruckLoadingApp.Domain.Models.Driver", "Driver")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_DriverSchedule_Drivers_DriverId");
